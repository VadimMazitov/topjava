        ...
        switch (action == null ? "all" : action) {
            ...
            case "update":
                final Meal meal = "create".equals(action) ?
                        ...
                        repository.get(getId(request), SecurityUtil.authUserId(),
                                LocalDate.parse(request.getParameter("startDate"), formatter),
                                LocalDate.parse(request.getParameter("endTime"), formatter));
            ...
            default:
                ...
                request.setAttribute("meals",
                        MealsUtil.getWithExcess(repository.getAll(SecurityUtil.authUserCaloriesPerDay(),
                                LocalDate.parse(request.getParameter("startDate"), formatter),
                                LocalDate.parse(request.getParameter("endTime"), formatter)),
