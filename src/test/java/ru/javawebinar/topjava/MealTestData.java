...
public class MealTestData {
    ...
    public static final MealTo MEAL_TO4 = new MealTo(MEAL4, true);
    public static final MealTo MEAL_TO5 = new MealTo(MEAL5, true);
    public static final MealTo MEAL_TO6 = new MealTo(MEAL6, true);
